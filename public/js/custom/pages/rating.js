var RatingSite = function() {
    ...
    var initRating = function(){
        ...
        jQuery.fn.raty.defaults.hints       = ['Mauvais', 'Passable', 'Moyen', 'Bon', 'Excellent'];
        ...
        jQuery('.js-rating').each(function(){
            ...
            $ratingEl.raty({
                ...
                click: function(score, evt) {
                   jQuery('input[name="rate"]').val(score);
    ...
    return {
        init: function () {
            // Init all Ratings
            initRating();
            if($('input[name="rate"]').length>0 && $('input[name="rate"]').val()!=''){
                $('.js-rating').raty('score', $('input[name="rate"]').val()); 
            }
        }
    };
}();
...
jQuery(function(){ RatingSite.init(); });